...
func (c *config) Read() error {
	...
	"logging.custom_logging_to_console", false)								// optional, true or false, indicates if custom logging is used, if the logging is to console rather than disk, default = false
